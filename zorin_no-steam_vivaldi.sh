...
# Positron (2025.12.1-4-x64)
wget https://cdn.posit.co/positron/releases/deb/x86_64/Positron-2025.12.1-4-x64.deb
sudo dpkg -i Positron*.deb
rm -rf Positron*.deb

# Vivaldi browser
wget https://downloads.vivaldi.com/stable/vivaldi-stable_7.7.3851.61-1_amd64.deb
